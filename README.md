...
- **React.js & Next.js ** Tanstack** – I use these frameworks to create dynamic user interfaces and server-rendered apps.  
- **SQL & PostgreSQL** – These tools help me manage data efficiently and run effective queries for backend systems.  
